...
public class MoverModuleManipulatorProperties extends PepperModuleProperties {
	...
	public MoverModuleManipulatorProperties() {
		...
		this.addProperty(new PepperModuleProperty<String>(SRCNAME, String.class, "Specifies the source object's type name, e.g. 'dep' for an edge named 'dep'.", "dep", false));
		...
		this.addProperty(new PepperModuleProperty<String>(SRCANNO, String.class, "Specifies the source annotation to move.", "func", true));
		this.addProperty(new PepperModuleProperty<String>(SRCANNONS, String.class, "Specifies the source annotation namespace, any namespace if null", null, true));
